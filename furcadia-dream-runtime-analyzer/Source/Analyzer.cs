...
namespace Dream_Runtime_Analyzer
{
    ...
    public class Analyzer
    {
        ...
        // Tells whether the data is timestamped: TSCF == TimeStamped
        // Capture File
        ...
        // The rest of the bandwidth captured. Initialized to 1 to avoid
        // DivByZero errors with bandwidth calculation.
        ...
        /// <summary>
        /// Initialize the Analyzer object while specifying whether
        /// timestamping support is intended.
        ///
        /// NOTE: The isTimestamped setting loses its effect when a file is
        ///       loaded from disk. It is re-evaluated when that happens!
        /// </summary>
        /// <param name="isTimestamped">
        /// TRUE if timestamping will be supported
        /// </param>
        ...
        {
            // To save time, don't reset twice - we know it's already
            // initialized so it will concatenate to nothing.
            Load(filename, true);
        }
        ...
        /// <summary>
        /// Gets the average DragonSpeak line spread across a single
        /// Six/Seven Trigger.
        /// </summary>
        ...
        /// instructions (empty lines) contain nothing in them but the
        /// NewLine (\n) character.
        /// </summary>
        ...
        //--- Time-dependent Data
        /// <summary>
        /// TRUE if data timestamping is available during capture, or the
        /// file loaded was a timestamped file. This does not necessarily
        /// mean that there is timed information available yet (which you
        /// check with the IsTimeAvailable property), it just mean that the
        /// format or code that gathers information uses timestamping.
        /// </summary>
        ...
        /// <summary>
        /// Gets the TimeSpan class that represents how long the data
        /// capture has been running. This value gets updated each time new
        /// data got processed!
        ///
        /// NOTE: If the IsTimeAvailable property is FALSE, this information
        ///       should be considered unavailable!
        ...
        /// <summary>
        /// Gets the amount of seconds for how long the data capture has
        /// been running. This value gets updated each time new data got processed!
        ///
        /// NOTE: If the IsTimeAvailable property is FALSE, this information
        ///       should be considered unavailable!
        /// </summary>
        ...
        /// <summary>
        /// Gets the amount of 6/7 instructions (SixTrigger and
        /// SevenTrigger) received so far. These instructions have the same
        /// syntax (except for the first byte) and are responsible for DS
        /// line execution requests.
        /// </summary>
        ...
        /// <summary>
        /// Get the amount of times a specific DragonSpeak line was
        /// requested by the server.
        /// </summary>
        /// <param name="instr">
        /// DragonSpeak Binary line number
        /// </param>
        /// <returns>
        /// Amount of times the DSB line was received
        /// </returns>
        ...
        /// <summary>
        /// Get the amount of times a specific server instruction was received.
        /// </summary>
        /// <param name="instr">
        /// Server instruction byte
        /// </param>
        /// <returns>
        /// Amount of times the instruction was received
        /// </returns>
        ...
        /// <summary>
        /// Returns a sorted dictionary for server instructions, sorted by
        /// the frequency of each instruction in a descending order (from
        /// most frequent to the least frequent).
        /// </summary>
        /// <returns>
        /// A SortedDictionary which uses the instruction frequency as the
        /// key and a list of instruction bytes as the value.
        /// </returns>
        ...
        /// <summary>
        /// Returns a sorted dictionary for server instructions, sorted by
        /// the instruction bytes in an ascending order (from the lowest
        /// character to the highest).
        /// </summary>
        /// <returns>
        /// A SortedDictionary which uses the instruction byte as the key
        ...
        /// frequency of each line in a descending order (from most frequent
        /// to the least frequent).
        /// </summary>
        /// <returns>
        /// A SortedDictionary which uses the line execution frequency as
        /// the key and a list of DS line numbers as the value.
        /// </returns>
        ...
        /// </param>
        /// <param name="concat">
        /// TRUE if we should add the data to the current one (FALSE by default)
        /// </param>
        ...
        /// </summary>
        /// <param name="data">
        /// Instruction data (with the trailing \n stripped)
        /// </param>
        /// <param name="timestamp">
        /// Timestamp of the data being received
        /// </param>
        ...
        ///
        /// NOTE: Supply the instruction WITHOUT the trailing \n character!
        /// NOTE: In a timestamped environment, a lack of the timestamp
        ///       parameter after 'data' places the current timestamp by default!
        /// </summary>
        /// <param name="data">
        /// Instruction data (with the trailing \n stripped)
        /// </param>
        ...
        /// <summary>
        /// Process a formatted data string with a UNIX timestamp at the beginning.
        /// </summary>
        /// <param name="data">
        /// Timestamped raw data from a TSCF file.
        /// </param>
        ...
        /// </summary>
        /// <returns>
        /// String representation of the Analyzer object
        /// </returns>
        ...
        private void ParseDsTrigger(string data)
        {
            ...
            for (int i = 9; i < data.Length; i += 6)
            {
                ...
                // If the line is above 8000, we have a slightly different
                // syntax since 0.28. We have an extra pair of bytes to tell
                // us the thousands.
                if (ln > 8000)
                {
                    i += 2;
    ...
    /// </typeparam>
    internal class ReverseComparer<T> : IComparer<T> where T : IComparable<T>
    {
